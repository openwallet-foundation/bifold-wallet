...
const translation = {
  ...
  "PinCreate": {
    ...
    "Helper": {
      ...
      "ConsecutiveTwoNumbersRepetitionValidation": 'Does not contain repeating 2 digits sequence (1818)',
      "SameNumberThreeTimesConsecutiveValidation": 'Does not contain three same consecutive numbers (111)',
      "SeriesOfThreeNumbersValidation": 'Does not contain a series of three numbers (123)',
