...
const translation = {
  ...
  PinCreate: {
    ...
    PINDisclaimer:
      "Si vous l'oubliez, vous devrez configurer à nouveau votre portefeuille et ajouter à nouveau vos cartes.",
    Show: 'Afficher',
    Hide: 'Masquer',
  ...
  PinEnter: {
    ...
    RepeatPIN: 'Essayer votre NIP à nouveau',
  ...
  Contacts: {
    ...
    TypeHere: 'Saisir le message ici',
  },
  ContactDetails: {
    Created: 'Créé',
  ...
  CredentialDetails: {
    ...
    CredentialRevokedMessageBody:
      "Ce justificatif peut ne plus fonctionner pour certaines demandes de preuve. Vous devrez mettre à jour le justificatif avec l'émetteur.",
    RemoveTitle: 'Retirer le justificatif du portefeuille',
    RemoveCaption:
      "Vous allez perdre la capacité d'utiliser ce portefeuille afin de prouver l'information se trouvant sur ce justificatif.",
    ...
    HowToGetThisCredentialBackListItem1:
      "Vous devrez vous rendre auprès de l'organisme qui vous a délivré ce justificatif et le redemander.",
  ...
  CredentialOffer: {
    ...
    ThisIsTakingLongerThanExpected:
      'Cela prend plus de temps que prévu. Revenez plus tard pour votre nouveau justificatif.',
    ...
    ConfirmDeclinedMessage:
      "Afin de recevoir à nouveau ce justificatif, vous devrez présenter une nouvelle demande auprès de l'émetteur.",
