...
import CredentialOffered from './components/Credential/Offered/index.tsx'
import CredentialRequested from './components/Credential/Requested/index.tsx'
...
import QRCodeScanner from './components/QRCodeScanner/index.tsx'
    ...
    const agentTest = async () => {
      ...
      await AMARN.createAgent({
        ...
        defaultMediatorConfig: {
          invite:
            'http://mediator2.test.indiciotech.io?c_i=',
