  ...
  const resolveOpenIDCredential = useCallback(
    async (uri: string) => {
      ...
      try {
        ...
        const credentialIssuer = resolvedCredentialOffer.metadata.credentialIssuer.credential_issuer
        ...
        const credentialEndpoint = resolvedCredentialOffer.metadata.credentialIssuer.credential_endpoint
