...
import { AttestationJWTData } from './hooks/attestation'
...
export type FN_ATTESTATION_GET_JWT = (attestationResult: string | string[], challenge: string, keyId: string, secondaryKey?: string) => Promise<AttestationJWTData>
