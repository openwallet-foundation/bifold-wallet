import { ProofRequestTemplate, hasPredicates, isParameterizable } from '@bryce-mcmath/aries-bifold-verifier'
import { MetaOverlay, OverlayType } from '@bryce-mcmath/aries-oca'
