...
import { BrandingOverlay, CaptureBaseAttributeType } from '@bryce-mcmath/aries-oca'
import { Attribute, CredentialOverlay, Predicate } from '@bryce-mcmath/aries-oca/build/legacy'
