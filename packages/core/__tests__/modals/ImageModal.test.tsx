...
describe('ImageModal component', () => {
  ...
  test('Triggers dismiss on press', () => {
    ...
    const { getByTestId } = render(<ImageModal uri={exampleURI} onDismissPressed={onDismissPressed} />)
