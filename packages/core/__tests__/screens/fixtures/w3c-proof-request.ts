      ...
      submissionEntry: [
        {
          ...
          name: undefined,
          purpose: undefined,
          verifiableCredentials: [{ claimFormat: ClaimFormat.LdpVc, credentialRecord: testW3cCredentialRecord }],
        },
      ],
      ...
      submissionEntry: [
        {
          ...
          verifiableCredentials: [
            { claimFormat: ClaimFormat.LdpVc, credentialRecord: testW3cCredentialRecord },
            { claimFormat: ClaimFormat.LdpVc, credentialRecord: testW3cCredentialRecord2 },
          ],
        },
      ],
      isRequirementSatisfied: true,
