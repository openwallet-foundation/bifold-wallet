...
import * as verifier from '@bryce-mcmath/aries-bifold-verifier'
...
jest.mock('@bryce-mcmath/aries-bifold-verifier', () => {
  const original = jest.requireActual('@bryce-mcmath/aries-bifold-verifier')
  return {
    ...original,
    __esModule: true,
