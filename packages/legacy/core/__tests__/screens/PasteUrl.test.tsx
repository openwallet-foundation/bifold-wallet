...
describe('displays a paste url screen', () => {
    ...
    test('Test valid url navigation', async () => {
        ...
        const textbox = tree.getByTestId(testIdWithKey('PastedUrl'))
        expect(textbox).not.toBeNull()
        textbox.props.onChangeText('didcomm://invite?oob=')
