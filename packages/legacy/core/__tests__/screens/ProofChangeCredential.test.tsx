        ...
        test('test credential selection', async () => {
            ...
            const tree = render(
                <ConfigurationContext.Provider value={configurationContext}>
                    <NetworkProvider>
                        <ProofChangeCredential navigation={navigation as any} route={{ params: { proofId: testProofRequest.id, selectedCred: credentialId, altCredentials: [credentialId, credentialId2], onCredChange } } as any} />
                    </NetworkProvider>
