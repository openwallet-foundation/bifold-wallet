...
const translation = {
  ...
  "PINCreate": {
    ...
    "Helper": {
      ...
      "PINTooShortValidation": "The PIN is not long enough. It should be at least {{num}} digits.",
      "PINTooLongValidation": "The PIN is too long. It should be maximum {{num}} digits.",
