...
const translation = {
  ...
  "Error": {
    ...
    "NotificationType": "NotificationType was not set correctly.",
    "InfoTextBoxType": "InfoTextBoxType needs to be set correctly.",
    "AFJ": "Unable to fetch agent from AFJ",
    "RemoveType": 'RemoveType cannot be undefined',
    "ToastType": 'ToastType was not set correctly.',
    "HomeContent": 'Credential count cannot be undefined.',
    "Commons": 'commonsContext must be used within a CommonUtilProvider',
    "Chat":  'Chat route params were not set properly',
    "CommonDecline":  'CommonDecline route params were not set properly',
    "ItemId":  'ItemId cannot be undefined',
    "DeclineType":  'DeclineType cannot be undefined',
    "UsageType":  'Usage type and artifact do not match',
    "Connection":  'Connection route props were not set properly',
    "Notification":  'Unhandled notification type',
    "CredentialDetails":  'CredentialDetails route params were not set properly',
    "CredentialOffer":  'CredentialOffer route params were not set properly',
    "Message1039":  'Problem',
    "ProofRequesting":  'ProofRequesting route params were not set properly',
    "ProofRequest":  'ProofRequest route params were not set properly',
    "RequestTemplate":  'Unable to find proof request template',
    "CaptureBase":  'Capture Base must be defined',
    "Invitation":  'Could not parse invitation from URL',
    "ConnexionRecord":  'Connection does not have an ID',
    "Record":  'Could not create new invitation',
    "Identifiers":  'Invalid indy proof data',
  },
  "ActivityLog": {
    "Your": "Your",
