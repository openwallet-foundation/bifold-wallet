...
const translation = {
  ...
  "PINCreate": {
    ...
    "Message": {
      ...
      "NoRepetitionMoreThanTwoTimesValidation": "More than 2 adjacent numbers are repeated in your PIN. Please try again.",
      "NoRepetitionMoreThanThreeTimesValidation": "More than 3 adjacent numbers are repeated in your PIN. Please try again.",
      "NoRepetitionMoreThanFourTimesValidation": "More than 4 adjacent numbers are repeated in your PIN. Please try again.",
    ...
    "Helper": {
      ...
      "NoRepetitionMoreThanTwoTimesValidation": "Maximum 2 adjacent numbers repeating are allowed in your PIN.",
      "NoRepetitionMoreThanThreeTimesValidation": "Maximum 3 adjacent numbers repeating are allowed in your PIN.",
      "NoRepetitionMoreThanFourTimesValidation": "Maximum 4 adjacent numbers repeating are allowed in your PIN.",
