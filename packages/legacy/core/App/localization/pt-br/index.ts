...
const translation = {
  ...
  "PINCreate": {
    ...
    "Message": {
      ...
      "NoRepetitionMoreThanTwoTimesValidation": "More than 2 adjacent numbers are repeated in your PIN. Please try again. (PT-BR)",
      "NoRepetitionMoreThanThreeTimesValidation": "More than 3 adjacent numbers are repeated in your PIN. Please try again. (PT-BR)",
      "NoRepetitionMoreThanFourTimesValidation": "More than 4 adjacent numbers are repeated in your PIN. Please try again. (PT-BR)",
    ...
    "Helper": {
      ...
      "NoRepetitionMoreThanTwoTimesValidation": "Maximum 2 adjacent numbers repeating are allowed in your PIN. (PT-BR)",
      "NoRepetitionMoreThanThreeTimesValidation": "Maximum 3 adjacent numbers repeating are allowed in your PIN. (PT-BR)",
      "NoRepetitionMoreThanFourTimesValidation": "Maximum 4 adjacent numbers repeating are allowed in your PIN. (PT-BR)",
