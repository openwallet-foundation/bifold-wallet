...
const translation = {
  ...
  "PINCreate": {
    ...
    "PinChangeSuccessTitle": "Successfully changed your PIN (PB)",
    "PinChangeSuccessMessage": "Your PIN was successsfully changed. You can now log in with your new PIN. (PB)",
    "EnterOldPINTitle": "Enter your old PIN (PB)",
    "NewPIN": "new",
    "EnterPINTitle": "Enter a {{ new }}6 digit PIN (PB)",
    "EnterPIN": "Digitar PIN",
    "ReenterPIN": "Re-enter {{ new }}PIN (PB)",
    "ReenterPINTitle": "Digitar novamente PIN",
    "CreatePIN": "Criar PIN",
    "RememberPIN": "Create a PIN to secure your wallet. (PT-BR)",
    "RememberChangePIN": "Change your PIN to secure your wallet. (PB)",
  ...
  "ProofRequest": {
    ...
    "PredicateNotSatisfied": "Predicado não satisfeito",
    ...
    "YouDoNotHaveDataPredicate": "Você não possui dados que satisfaçam o predicado",
