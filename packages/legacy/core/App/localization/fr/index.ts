...
const translation = {
  ...
  Tour: {
    ...
    AddAndShareDescription:
      "Pour ajouter et utiliser des attestations d'identité, vous devez scanner un code QR affiché par le fournisseur de services.",
    AddCredentials: 'Ajouter des attestations',
    AddCredentialsDescription:
      'Ajouter des attestations en balayant le code QR affiché par le fournisseur de services.',
    Notifications: 'Notifications',
    NotificationsDescription:
      "Après avoir scanné un code QR, l'offre d'attestation d'identité ou la demande de preuve apparaîtra ici, ainsi que d'autres événements notables.",
    YourCredentials: "Vos attestations d'identité",
    YourCredentialsDescription:
      "Vos attestations d'identité numériques ajoutées apparaissent ici. Vous pouvez réviser, ajouter et supprimer votre attestation d'identité.",
    CredentialOffers: "Offre d'attestation",
    CredentialOffersDescription:
      "Une organisation vous a offert une attestation d'identité. Révisez les détails de l'attestation et choisissez de l'accepter ou de le refuser. Les attestations acceptés seront ajoutés à votre portefeuille.",
    ProofRequests: 'Demandes de preuves',
    ProofRequestsDescription:
      "Une organisation vous demande de prouver vos attestations d'identité. Révisez ce qu'ils demandent et choisissez d'accepter ou de refuser.",
    Skip: 'Passer',
    Next: 'Suivant',
    Back: 'Précédent',
    Done: 'Terminer',
  ...
  CameraDisclosure: {
    ...
    CameraDisclosure:
      "La caméra est utilisée pour capturer les codes QR qui initient une offre d'attestation d'identité ou une demande de preuve. Aucune information de l'image n'est sauvegardée, utilisée pour les analyses, ou partagée.",
    ToContinueUsing:
      "Autoriser l'utilisation de la caméra, pour continuer à utiliser la fonctionnalité de balayage du Portefeuille QC.",
  ...
  PINCreate: {
    Explainer: {
      ...
      PINReminder:
        'On the following screen you will be asked to set up a strong <b>personal identification number</b> (PIN). (FR)',
      WhyNeedPin: {
        ...
        ParagraphList2:
          'Or use your biometrics to open your wallet, and if your biometrics change change on your device you will need to use the PIN to authenticate your wallet (FR)',
      },
    },
    Message: {
  ...
  Biometry: {
    ...
    EnabledText1:
      'Déverrouiller votre portefeuille avec la biométrie de votre appareil au lieu d’utiliser le NIP du portefeuille.',
    EnabledText2:
    ...
    AllowBiometricsDesc:
      'Pour déverrouiller BC Wallet avec votre biométrie, permettrez la biométrie dans les paramètres de votre appareil.',
    SetupBiometricsTitle: "La biométrie n'est pas activée",
    SetupBiometricsDesc:
      'Pour déverrouiller BC Wallet avec votre biométrie, configurez votre biométrie dans les paramètres de votre appareil.',
    OpenSettings: 'Ouvrir les paramètres',
  },
  ActivityHistory: {
    ...
    Description:
      'Set how long you want to keep your activity history before it is deleted from your device (it is not stored anywhere else).(fr)',
    ...
    DeleteActivityHistory: {
      ...
      Description:
        'Individual history can be deleted in the history tab or you can delete all activity history. This action cannot be undone.(fr)',
    ...
    StopActivityHistoryScreen: {
      ...
      Description:
        'No further activity history will be kept in the Ontario Wallet. All previous history will remain.(fr)',
  ...
  History: {
    ...
    Initial: {
      ...
      Description: {
        ...
        FooterAxs:
          'Your wallet activity will only be stored on your device, and you can choose how often it is automatically deleted.(fr)',
      },
      Button: {
  ...
  ContactDetails: {
    ...
    UnableToRemoveCaption:
      "Impossible de supprimer car il y a des attestations d'identité émises par ce Contact dans votre portefeuille. Supprimez d'abord les attestations d'identité, puis supprimez ce Contact.",
  ...
  PushNotifications: {
    ...
    NotificationsOffMessage:
      "Soyez averti lorsque vous recevez de nouvelles offres d'attestations, des demandes de preuve, des mises à jour de vos attestations, de nouveaux messages et plus encore.",
  ...
  CredentialDetails: {
    ...
    RemoveCaption:
      "Vous allez perdre la capacité d'utiliser ce portefeuille afin de prouver l'information se trouvant sur cette attestation.",
    ...
    HowToGetThisCredentialBackListItem1:
      "Vous devrez vous rendre auprès de l'organisme qui vous a délivré cette attestation et le redemander.",
  ...
  Scan: {
    ...
    ScanOnlySpecial2:
      "Ceux-ci sont présentés par des services ou des personnes participantes pour recevoir une offre d'attestation, une demande d'information ou pour se connecter.",
    ScanOnlySpecial3:
      "Bifold Wallet ne prend actuellement pas en charge l'ajout d'attestations numériques en scannant ou en prenant des photos d'attestations physiques.",
    WhereToUseLink: 'Voir où vous pouvez utiliser Bifold Wallet',
    BadQRCode: "Le code QR n'est pas reconnu",
    BadQRCodeDescription:
      "Ce code QR scanné ne fonctionne pas avec Bifold Wallet. Bifold Wallet ne fonctionne qu'avec les services participants.\n\nIl ne peut actuellement pas ajouter d'attestations numériques en prenant des photos d'attestations physiques.",
  },
  PasteUrl: {
    PasteUrl: 'Coller une URL',
    PasteUrlDescription:
      'Collez une URL ci-dessous pour recevoir une demande de preuve, ajouter un titre ou un contact.',
    Clear: 'Effacer',
    ...
    ErrorInvalidUrlDescription:
      "Vérifiez si l'URL est destinée aux portefeuilles numériques et si elle a été copiée correctement, puis réessayez.",
  },
  Connection: {
    JustAMoment: 'Veuillez patienter pendant que nous établissons une connexion sécurisée...',
    TakingTooLong:
      "Cela prend plus de temps que d'habitude. Vous pouvez retourner à l'accueil ou continuer à attendre.",
  ...
  CredentialOffer: {
    ...
    ConfirmDeclinedMessage:
      "Afin de recevoir à nouveau cette attestation, vous devrez présenter une nouvelle demande auprès de l'émetteur.",
    AbortDecline: 'Non, revenir en arrière',
    DeclineTitle: "Refuser l'offre d'attestation d'identité?",
    Declined: 'Refusé',
    DeclineParagraph1:
      "Afin de recevoir à nouveau l'offre d'attestation d'identité, vous devrez recommencer le processus d'émission avec le service d'émission.",
  ...
  ProofRequest: {
    ...
    Declined: 'Diminué',
    ReviewSentInformation_one:
      "Vous avez partagé les informations suivantes à partir des attestations d'identité {{count}} avec",
    ReviewSentInformation_other:
      "Vous avez partagé les informations suivantes à partir des attestations d'identité {{count}} avec",
    ShareFollowingInformation_one:
      "partage les informations suivantes à partir des informations d'identification {{count}}.",
    ShareFollowingInformation_other:
      "partage les informations suivantes à partir des informations d'identification {{count}}.",
    DeclineBulletPoint1:
      'Les organisations et les services exigent que vous prouviez que vous êtes éligible pour continuer avec leur service ou leur accès.',
    DeclineBulletPoint2:
      'Afin de recevoir à nouveau la demande de preuve, vous devrez relancer le processus avec le service.',
  ...
  NameWallet: {
    ...
    CharCountDescription:
      'Vous avez dépassé le nombre maximum de caractères de 50 caractères. Veuillez réduire votre nombre de caractères.',
    EmptyNameTitle: 'Le portefeuille doit avoir un nom',
    EmptyNameDescription:
      "C'est le nom que les gens voient lorsqu'ils se connectent avec vous.\n\nVeuillez entrer un nom de portefeuille.",
  },
  RenameContact: {
  ...
  NetInfo: {
    ...
    NoInternetConnectionMessage:
      "Vous ne pouvez pas accéder aux services à l'aide de Bifold ou recevoir des informations d'identification tant que vous n'êtes pas de nouveau en ligne.\n\nS'il vous plait, vérifiez votre connexion internet.",
  },
  Onboarding: {
  ...
  Preface: {
    ...
    Paragraph1:
      "La plupart des gens n'auront pas besoin d'Aries Bifold car très peu d'informations d'identification numériques sont actuellement disponibles.",
