...
const translation = {
    ...
    "Error": {
        ...
        "NotificationType": "NotificationType n'a pas été défini correctement.",
        "InfoTextBoxType": "InfoTextBoxType doit être défini correctement.",
        "AFJ": "Impossible de récupérer l'agent de l'AFJ",
        "RemoveType": 'RemoveType ne peut pas être indéfini',
        "ToastType": "ToastType n'a pas été défini correctement.",
        "HomeContent": 'Credential count ne peut pas être indéfini.',
        "Commons": 'CommonsContext doit être utilisé dans un CommonUtilProvider',
        "Chat":  "Les paramètres de navigation de Chat n'ont pas été définis correctement",
        "CommonDecline":  "Les paramètres de navigation de CommonDecline n'ont pas été définis correctement",
        "ItemId":  'ItemId ne peut pas être indéfini',
        "DeclineType":  'DeclineType ne peut pas être indéfini',
        "UsageType":  "Le type d'utilisation et l'artefact ne correspondent pas",
        "Connection":  "Les props de navigation de Connexion n'ont pas été définis correctement",
        "Notification":  'Type de notification non géré',
        "CredentialDetails":  "Les paramètres de navigation de CredentialDetails n'ont pas été définis correctement",
        "CredentialOffer":  "Les paramètres de navigation de CredentialOffer n'ont pas été définis correctement",
        "Message1039":  'Problème',
        "ProofRequesting":  "Les paramètres de navigation de ProofRequesting n'ont pas été définis correctement",
        "ProofRequest":  "Les paramètres de navigation de ProofRequest n'ont pas été définis correctement",
        "RequestTemplate":  'Impossible de trouver le modèle de demande de preuve',
        "CaptureBase":  'La base de capture doit être définie',
        "Invitation":  "Impossible d'analyser l'invitation à partir de l'URL",
        "ConnexionRecord":  "La connexion n'a pas d'ID",
        "Record":  'Impossible de créer une nouvelle invitation',
        "Identifiers":  'Données de preuve indy invalides',
    },
    "ActivityLog": {
        "Your": "Votre ",
    ...
    "Tour": {
        ...
        "UseAppGuides": "Utiliser les guides d'applications",
        "DoNotUseAppGuides": "N'utilisez pas les guides d'application",
        ...
        "YourCredentialsDescription": "Vos justificatifs d'identité numériques ajoutées apparaissent ici. Vous pouvez consulter les justificatifs d'identité et ajouter et supprimer des justificatifs d'identité.",
        "Skip": "Passer",
        "Next": "Suivant",
        "Back": "Précédent",
        "Done": "Terminer",
    ...
    "ProofRequest": {
        ...
        "IsRequestingYouToShare": "demande les informations suivantes à ",
        ...
        "DeclineTitle": "Refuser le justificatif d'identité",
        "Declined": "Diminué",
