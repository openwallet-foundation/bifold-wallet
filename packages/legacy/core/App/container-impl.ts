...
export class MainContainer implements Container {
  ...
  public init(): Container {
    ...
    this._container.registerInstance(TOKENS.COMPONENT_CONNECT_SCAN_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONNECT_SCAN_HELP_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONNECT_PASTE_URL_HEADER_RIGHT, () => null)
    ...
    this._container.registerInstance(TOKENS.COMPONENT_CRED_DETAILS_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CRED_OPEN_ID_HEADER_RIGHT, () => null)
    ...
    this._container.registerInstance(TOKENS.COMPONENT_DELIVERY_PROOF_HEADER_RIGHT,() => null)
    this._container.registerInstance(TOKENS.COMPONENT_DELIVERY_CRED_OFFER_HEADER_RIGHT,() => null)
    this._container.registerInstance(TOKENS.COMPONENT_DELIVERY_OPEN_ID_HEADER_RIGHT,() => null)
    this._container.registerInstance(TOKENS.COMPONENT_NOTIFICATION_CRED_DETAILS_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_NOTIFICATION_CRED_OFFER_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_NOTIFICATION_PROOF_REQ_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_NOTIFICATION_CUSTOM_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_DETAILS_HEADER_RIGHT, HeaderRightHome)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_REQ_DETAILS_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_CHANGE_CRED_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_USAGE_HISTORY_HEADER_RIGHT, HeaderRightHome)
    this._container.registerInstance(TOKENS.COMPONENT_PROOF_REQUESTING_HEADER_RIGHT, () => null)
    ...
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_DETAILS_LIST_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_RENAME_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_CHAT_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_WHAT_ARE_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_DETAILS_CRED_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_OFFER_CRED_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_DETAILS_PROOF_HEADER_RIGHT, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_REQUEST_PROOF_HEADER_RIGHT, () => null)
